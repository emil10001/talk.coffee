...
function splash(_ref) {
  ...
  })), dom("input.form-item type=email placeholder=you@yourdomain.com " + (!iframe ? "autofocus" : "")), dom("button.loading", "Get my Invite")), !iframe && dom("footer", "powered by ", dom("a href=http://rauchg.com/slackin target=_blank", "slackin")), style({ logo: logo, active: active, iframe: iframe }),
  // xxx: single build
